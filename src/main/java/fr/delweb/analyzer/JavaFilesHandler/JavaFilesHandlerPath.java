...
import fr.delweb.analyzer.Common.Exceptions.NoJavaPathExceptions;
...
public class JavaFilesHandlerPath implements IJavaFilesHandler {
    ...
    public JavaFilesHandlerPath() throws IOException {
        this.allPathJava = this.allPathJava();
    }

    public JavaFilesHandlerPath(String path) throws IOException {
