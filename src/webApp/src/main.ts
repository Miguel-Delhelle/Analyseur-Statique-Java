...
import { CleanDendrogramRenderer } from './dendrogram-clean';
...
class AnalyzerApp {
    ...
    private dendrogramRenderer: CleanDendrogramRenderer;
    ...
    constructor() {
        this.dendrogramRenderer = new CleanDendrogramRenderer();
    ...
    private bindEvents(): void {
        ...
        testBtn.addEventListener('click', () => {
            ...
            this.displayDendrogramGraph(testData);
        });
    ...
    private openFullscreen(graphType: 'call' | 'coupling' | 'dendrogram'): void {
        ...
        if (graphType === 'call') {
            ...
            if (this.currentAnalysisData && this.currentAnalysisData.rootDendro) {
                this.dendrogramRenderer.render(this.currentAnalysisData.rootDendro, this.fullscreenGraph);
            }
        }
    }
    ...
    private displayDendrogramGraph(rootDendro: DendroNode): void {
        console.log('Affichage du dendrogramme (renderer logique):', rootDendro);
        this.dendrogramGraph.innerHTML = '';
        this.dendrogramRenderer.render(rootDendro, this.dendrogramGraph);
    }



    // Fonction avec TOUTES vos données réelles complètes
